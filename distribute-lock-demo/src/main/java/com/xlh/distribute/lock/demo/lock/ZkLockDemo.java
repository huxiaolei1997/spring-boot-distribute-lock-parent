package com.xlh.distribute.lock.demo.lock;
...
@Slf4j
public class ZkLockDemo implements Watcher,AutoCloseable {

    private ZooKeeper zooKeeper;
    private String businessName;
    private String znode;

    public ZkLockDemo(String connectString, String businessName) throws IOException {
